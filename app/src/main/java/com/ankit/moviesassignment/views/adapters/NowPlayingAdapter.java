...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.MyViewHolder> {
    ...
    public void setClickListener(NowPlayingFragment itemClickListener) {
        this.clickListener = itemClickListener;
    }

    public NowPlayingAdapter(ArrayList<MovieListData> movies) {
        this.movies = movies;
    }

    @Override
    public NowPlayingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_movies, parent, false);

        context = itemView.getContext();

        return new NowPlayingAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final NowPlayingAdapter.MyViewHolder holder, int position) {
